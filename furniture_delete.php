...
<header>
	...
	<h1 style="font-size:30px">Furniture Delete</h1>
</header>
...
<a href="admin_furniture.php"><button class="button">Furniture</button></a>
		<?php
			...
			if ($_POST["Delete"] ){
				$sql="DELETE FROM furniture WHERE fu_id ='$Furniture_ID'";
				if(mysql_query($sql)) {
	...
	<head>
		<title> MKM Furniture DELETE </title>
	...
	<body>
            <div class="fm">
			<center>
		<form action="furniture_delete.php" method="POST">
