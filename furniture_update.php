...
<header>
	...
	<h1 style="font-size:30px">Furniture Update</h1>
...
<a href="admin_furniture.php"><button class="button">Furniture</button></a>
	...
	<head>
		<title> MKM Furniture UPDATE </title>
	...
	<body>
            <div class="fm">
			<center>
		<form action="furniture_update.php" method="POST">
		
			Furniture ID :<br> <input type = "text" name="fu_id"><br>
			Price :<br><input type = "number" name="price"><br>
			<input type="submit" name="Update" value="UPDATE"></tr>
		</form>
           <center>        
		</div>
